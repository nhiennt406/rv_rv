...
import { Button, Container, Grid, ItemExtra, TextArea } from "semantic-ui-react";
const PaymentContent = () => {
  ...
  return (
    ...
    <Container>
      ...
      <p>Tạo tin thành công</p>
      <label>Cảm ơn bạn đã cho chúng tôi cơ hội được phục vụ !</label>
      <p></p>
      <label>
        Chúng tôi sẽ kiểm tra và xác nhận tin bạn tạo sớm nhất có thể!{" "}
      </label>
      <p></p>

      <Link to="/bike" className="ui primary basic button">

        <p>  Chuyển đến trang rao vặt xe cộ </p>
      </Link>
        ...
        <div class="table-responsive">
          <form action='create_payment_url' method='POST'>
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="order_id" name="order_id" type="text" value="SS" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="txtexpire"
                name="txtexpire" type="text" value="SS" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="txt_bill_state"
                name="txt_bill_state" type="text" value="SSS" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="txt_ship_state"
                name="txt_ship_state" type="text" value="SS" />
            </div>
            <div class="form-group">
              <label >Quốc gia (*)</label>
